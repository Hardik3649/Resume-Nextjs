          ...
          <div className="container">
            ...
            <div className="pt-10 xl:pt-16 flex gap-10 items-center justify-between">
              ...
              <div className="w-full lg:max-w-2xl flex-1">
                <p>
                  A dedicated HR recruitment professional specializing in talent acquisition,
                  candidate assessment, and strategic workforce planning.
                  Committed to connecting exceptional talent with outstanding opportunities
                  while ensuring an optimal candidate experience throughout the hiring process.
                </p>

                <div className="grid grid-cols-3 py-10 xl:py-16 gap-5 border-b border-mistGray">
                  {[
                    { count: "05", label: "Years of experience" },
                    { count: "15+", label: "Achievements" },
                    { count: "95%", label: "Joining Ratio" },
                  ].map((item, i) => (
                    <div key={i}>
                      <h3>{item.count}</h3>
